...
export const objections: Objection[] = [
  ...
  },
  {
    ...
    answer:
      "This objection would be decisive against a proposal to standardise club football — but that is not what is being proposed here. The argument is for a translation layer that sits above club systems: a shared national vocabulary and set of rehearsed responses that helps England-qualified players and coaches communicate with each other during the small amount of time they spend together as a national squad, without requiring any club to change how it plays.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "The claim being made here is narrower and more modest than 'a framework wins tournaments': it is that a team with shared collective understanding converts a given level of individual talent into performance more reliably than a team without it. That claim is compatible with variance and misfortune still deciding many specific results — it is a claim about the conditional probability of good performance given the talent available, not a claim about guaranteed outcomes.",
  },
  {
    id: "pluralism-creates-confusion",
    objection: "Tactical pluralism will create confusion, not adaptability.",
    concession:
      "Unmanaged tactical pluralism can indeed create exactly this problem — a squad of players with genuinely contradictory habits and no shared reference points is a real coordination risk, not a hypothetical one.",
    answer:
  ...
  },
  {
    ...
    answer:
      "The word doing the most work in this objection is 'rigid', and it does not hold up against Spain's own history. Spain endured decades of underachievement before 2008 with similarly talented players, and the team's approach has itself evolved considerably since 2012, including the faster, more transitional side that won Euro 2024. What Spain actually demonstrates is shared principles sustained and adapted across multiple coaching generations, not one fixed, unchanging identity — which is closer to structured adaptability than to rigidity.",
  },
];
